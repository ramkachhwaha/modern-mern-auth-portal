...
const Home = () => {
    ...
    // Data for Panels (Images & SVGs)
    const panels = [
        {
            title: "MongoDB",
            img: "./IconeSVG/mongodb.svg",
            icon: <FaDatabase />
        },
        {
            title: "Express.js",
            img: "./IconeSVG/icons8-express-js-480.svg",
            icon: <SiExpress />
        },
        {
            title: "React",
            img: "./IconeSVG/react.svg",
            icon: <FaReact />
        },
        {
            title: "Node.js",
            img: "./IconeSVG/icons8-nodejs.svg",
            icon: <FaNodeJs />
        }
    ];
                        ...
                        >
                            ...
                            >
                                {loggedUser && loggedUser.user_name ? (
                                    loggedUser.user_name.split("").map((letter, index) => (
                    ...
                    {panels.map((panel, index) => (
                        ...
                        >
                            ...
                            <div className="panel-content">
                                ...
                                <div className="panel-icon h-auto! w-2! ">
                                    {panel.icon}
                                </div>
                            </div>
                        </div>
...
//                             </a>
//                             <img
//                                 src='./homePageSVG/icons8-express-js-480.svg'
...
//                                 src='./homePageSVG/icons8-nodejs.svg'
...
//                     {/* Wellcome word */}
//                     <h1>
//                         <span className="gradient-text letter">W</span>
//                         <span className="gradient-text letter">E</span>
//                         <span className="gradient-text letter">L</span>
//                         <span className="gradient-text letter">L</span>
//                         <span className="gradient-text letter">C</span>
//                         <span className="gradient-text letter">O</span>
//                         <span className="gradient-text letter">M</span>
//                         <span className="gradient-text letter">E</span>
//                     </h1>
